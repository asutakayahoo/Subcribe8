...
new SocketClient('repusdt', 3, 3610000); 
new SocketClient('requsdt', 4, 3615000); 
new SocketClient('rifusdt', 5, 3620000); 
new SocketClient('rlcusdt', 6, 3625000); 
new SocketClient('rndrusdt', 7, 3630000); 
new SocketClient('roseusdt', 8, 3635000); 
new SocketClient('rsrusdt', 9, 3640000); 
new SocketClient('runeusdt', 10, 3645000); 
new SocketClient('rvnusdt', 11, 3650000); 
new SocketClient('sandusdt', 12, 3655000); 
new SocketClient('santusdt', 13, 3660000); 
new SocketClient('scrtusdt', 14, 3665000); 
new SocketClient('scusdt', 15, 3670000);
new SocketClient('sfpusdt', 16, 3675000); 
new SocketClient('shibusdt', 17, 3680000); 
new SocketClient('sklusdt', 18, 3685000); 
new SocketClient('slpusdt', 19, 3690000); 
new SocketClient('snxusdt', 20, 3695000); 
new SocketClient('solususdt', 21, 3700000); 
new SocketClient('spellusdt', 22, 3705000); 
new SocketClient('steemusdt', 23, 3710000); 
new SocketClient('stgusdt', 24, 3715000); 
new SocketClient('stmxusdt', 25, 3720000); 
new SocketClient('storjusdt', 26, 3725000); 
new SocketClient('stptusdt', 27, 3730000);
new SocketClient('straxusdt', 28, 3735000); 
new SocketClient('stxusdt', 29, 3740000); 
new SocketClient('sunusdt', 30, 3745000); 
new SocketClient('superusdt', 31, 3750000); 
new SocketClient('sushiusdt', 32, 3755000); 
new SocketClient('sxpusdt', 33, 3760000); 
new SocketClient('sysusdt', 34, 3765000); 
new SocketClient('tfuelusdt', 35, 3770000); 
new SocketClient('thetausdt', 36, 3775000);
new SocketClient('tkousdt', 37, 3780000);
new SocketClient('tlmusdt', 38, 3785000); 
new SocketClient('tomousdt', 39, 3790000); 
new SocketClient('tornusdt', 40, 3795000); 
